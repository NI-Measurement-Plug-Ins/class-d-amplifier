...
<Library LVVersion="21008000">
	...
	<Item Name="data justification.ctl" Type="VI" URL="../data justification.ctl"/>
	<Item Name="digital audio protocol settings.ctl" Type="VI" URL="../digital audio protocol settings.ctl"/>
	<Item Name="digital edge.ctl" Type="VI" URL="../digital edge.ctl"/>
	<Item Name="endianness.ctl" Type="VI" URL="../endianness.ctl"/>
	<Item Name="logic level.ctl" Type="VI" URL="../logic level.ctl"/>
</Library>
